...
# print(image.getInfo())
ee.mapclient.centerMap(-122.1899, 37.5010, 10)
...
# ee.mapclient.addToMap(ndwi, ndwiViz, 'NDWI')

# Masking
ndwiMasked = ndwi.updateMask(ndwi.gte(0.4))
# ee.mapclient.addToMap(ndwiMasked, ndwiViz, 'NDWI masked')
...
# ee.mapclient.addToMap(mosaic, {}, 'mosaic')


roi = ee.Geometry.Point([-122.4481, 37.7599]).buffer(20000)
ee.mapclient.addToMap(image.clip(roi), vis)
ee.mapclient.addToMap(ndwiMasked.clip(roi),ndwiViz)
